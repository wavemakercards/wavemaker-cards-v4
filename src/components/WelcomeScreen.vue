...
<div style="text-align:center">
        ...
        <div style="text-align:center; font-size:2rem"> This is an ALPHA version and is for testing only</div>
</div>

  <button @click="$root.$data.popup.name='GoogleDrive'" class="clearInterfaceIconButton"> 
...
<!--
   <button @click="$root.$data.popup.name='ApiForm'" class="clearInterfaceIconButton"> 
    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
   ...
   -->
   <button @click="$root.file_loadDB" class="clearInterfaceIconButton">  
<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
<table style="width:100%">
  ...
  <tr>
    <td><input v-model="projname" class="formInput" placeholder="New Project Name"/></td>
    <td style="width:50px;"><button class="formButton" @click="MakeSettings">
   <svg style="width:24px;height:24px" viewBox="0 0 24 24">
